...
import static com.example.justlisten.MainActivity.ARTIST_TO_FRAG;
import static com.example.justlisten.MainActivity.PATH_TO_FRAG;
import static com.example.justlisten.MainActivity.SHOW_MINI_PLAYER;
import static com.example.justlisten.MainActivity.SONG_NAME_TO_FRAG;
        ...
        if (SHOW_MINI_PLAYER) {
            if (PATH_TO_FRAG != null) {
                ...
                if (art != null) {
                    ...
                    Glide.with(getContext()).load(R.drawable.ic_launcher)
                            .into(albumArt);
                }
