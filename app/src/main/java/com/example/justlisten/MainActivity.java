...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    private void permission() {
        if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            ActivityCompat.requestPermissions(com.example.justlisten.MainActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}
                    , REQUEST_CODE);
        } else {
    ...
    private void initViewPager() {
        ...
        viewPagerAdapter.addFragments(new AlbumFragment(), "Livres");
        viewPagerAdapter.addFragments(new SongsFragment(), "Chapitres");
    ...
    public boolean onQueryTextChange(String newText) {
        ...
        for (MusicFiles album : albums) {
            if (album.getAlbum().toLowerCase().contains(userInput) | album.getArtist().toLowerCase().contains(userInput)) {
                albumFiles.add(album);
            }

        }
        SongsFragment.musicAdapter.updateList(myFiles);
        AlbumFragment.albumAdapter.updateList(albumFiles);
        return true;
    }
    ...
    public void closeBookActivity(View view){
        finish();
    }
}